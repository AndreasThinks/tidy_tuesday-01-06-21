# Code of conduct for `tidy_tuesday-01-06-21`

Contributors to this repository hosted by `mps-siu` are expected to follow the Contributor
...
- "Project", we mean this `tidy_tuesday-01-06-21` GitHub repository;
- "Maintainer", we mean the `mps-siu` organisation owners; and
- "Leadership", we mean both `mps-siu` organisation owners, line managers, and other
  leadership within MPS-SIU.
...
[andreas.varotsis@gmail.com][email-address]. All complaints will be reviewed and investigated and
...
[email-address]: mailto:andreas.varotsis@gmail.com
